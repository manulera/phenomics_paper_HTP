...
for data_file, gene_column, condition_column, is_rna, allele_type, expression in settings:
    ...
    for sheet_name in sheet_names:
        ...
        data.rename(columns={condition_column: 'condition'}, inplace=True)
        all_data.append(data)

pandas.concat(all_data).to_csv('results/pombase_intermediate_dataset.tsv', index=False, sep='\t')